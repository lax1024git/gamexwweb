...
import { v2_team_childBet_api } from "@/api/team";
import { ResCode } from "@/enum/ResultCode";
import { V2TeamChildBetItem } from "@/types/api/team";
...
const list: Ref<V2TeamChildBetItem[]> = ref([]);
const getList = async () => {
  loading.value = true;
  const res = await v2_team_childBet_api({
